...
public class Complain {
    ...
    public String incidentDateMonth;
    public String incidentDateYear;
    public String incidentDescription;
    public String incidentSpotDescription;
    public String incidentSpotDistrict;
    public String incidentSpotDivision;
    public String incidentSpotSubLocation;
    public String incidentSpotType;
    ...
    public Complain(String complainSubject, String gander, String incidentDate,
                    ...
                    String incidentSpotSubLocation, String incidentSpotType, String incidentTime,
                    String name, String nationalID, String phoneNumber, String presentAddress,
                    String postDate,String postTime) {
