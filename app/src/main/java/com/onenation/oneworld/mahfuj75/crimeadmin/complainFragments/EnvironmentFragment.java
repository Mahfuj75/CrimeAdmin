package com.onenation.oneworld.mahfuj75.crimeadmin.complainFragments;
...
public class EnvironmentFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        {
            mQuery = mRef.orderByChild("subLocationSubjectProcess").equalTo(crimeSubLocation+"_পরিবেশ"+"_0");
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        complainRecyclerView = (RecyclerView) view.findViewById(R.id.complainRecyclerViewEnvironment);
        ...
        textViewFragment = (TextView) view.findViewById(R.id.textView_fragmentEnvironment) ;
