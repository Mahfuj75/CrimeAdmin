...
public class DemandFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        {
            mQuery = mRef.orderByChild("subLocationSubjectProcess").equalTo(crimeSubLocation+"_চাহিদা"+"_0");
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        complainRecyclerView = (RecyclerView) view.findViewById(R.id.complainRecyclerViewDemand);
        ...
        textViewFragment = (TextView) view.findViewById(R.id.textView_fragmentDemand) ;
