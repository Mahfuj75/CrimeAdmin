...
import com.onenation.oneworld.mahfuj75.crimeadmin.complainFragments.AllFragment;
...
public class ValidationFragment extends Fragment {
    ...
    public static ValidationFragment newInstance(String param1, String param2) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Toast.makeText(getActivity(),crimeAdminType+" ,"+crimeSubLocation+" ,"+crimeDistrict+" ,"+crimeDivision,Toast.LENGTH_LONG).show();

        mRef = FirebaseDatabase.getInstance().getReference().child("Complain");

        if(crimeAdminType.equals("1"))
        {
            mQuery = mRef.orderByChild("subLocationProcess").equalTo(crimeSubLocation+"_1");
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        complainRecyclerView = (RecyclerView) view.findViewById(R.id.complainRecyclerViewValidation);
        ...
        textViewFragment = (TextView) view.findViewById(R.id.textView_fragmentValidation) ;
    ...
    public void onResume() {
        super.onResume();
        complainRecyclerView.setAdapter(firebaseRecycleComplainAdapter);
        complainRecyclerView.invalidate();
    }
