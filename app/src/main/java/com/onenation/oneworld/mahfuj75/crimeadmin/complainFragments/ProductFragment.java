...
public class ProductFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        {
            mQuery = mRef.orderByChild("subLocationSubjectProcess").equalTo(crimeSubLocation+"_পণ্য"+"_0");
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        complainRecyclerView = (RecyclerView) view.findViewById(R.id.complainRecyclerViewProduct);
        ...
        textViewFragment = (TextView) view.findViewById(R.id.textView_fragmentProduct) ;
