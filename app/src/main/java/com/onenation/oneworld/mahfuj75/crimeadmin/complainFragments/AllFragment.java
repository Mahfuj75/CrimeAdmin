...
public class AllFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        {
            mQuery = mRef.orderByChild("subLocationProcess").equalTo(crimeSubLocation+"_0");
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        complainRecyclerView = (RecyclerView) view.findViewById(R.id.complainRecyclerViewAll);
        ...
        textViewFragment = (TextView) view.findViewById(R.id.textView_fragmentAll) ;
