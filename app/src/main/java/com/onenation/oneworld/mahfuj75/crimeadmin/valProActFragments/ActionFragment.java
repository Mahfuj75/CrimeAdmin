...
public class ActionFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        {
            mQuery = mRef.orderByChild("subLocationProcess").equalTo(crimeSubLocation+"_3");
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        complainRecyclerView = (RecyclerView) view.findViewById(R.id.complainRecyclerViewAction);
        ...
        textViewFragment = (TextView) view.findViewById(R.id.textView_fragmentAction) ;
