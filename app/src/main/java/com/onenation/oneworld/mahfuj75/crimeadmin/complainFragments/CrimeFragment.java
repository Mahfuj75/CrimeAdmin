...
public class CrimeFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        {
            mQuery = mRef.orderByChild("subLocationSubjectProcess").equalTo(crimeSubLocation+"_অপরাধ"+"_0");
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        complainRecyclerView = (RecyclerView) view.findViewById(R.id.complainRecyclerViewCrime);
        ...
        textViewFragment = (TextView) view.findViewById(R.id.textView_fragmentCrime) ;
